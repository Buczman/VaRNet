...
data = data.loc[(data.index > '2005-01-01')]
...
data.iloc[:1000+num_train].reset_index().join(pd.DataFrame(var_output, index=list(range(1000, 1000+num_train)), columns=['VaR']))[['Data', 'log_returns', 'VaR']].to_csv('test2.csv')
